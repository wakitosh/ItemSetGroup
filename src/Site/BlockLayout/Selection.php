...
class Selection extends AbstractBlockLayout {
  ...
  public function form(PhpRenderer $view, SiteRepresentation $site, ?SitePageRepresentation $page = NULL, ?SitePageBlockRepresentation $block = NULL) {
    ...
    // No localized heading field (reverted to single input).
    ...
    // No localized description field (reverted to single input).
...
JS);
  ...
  public function onHydrate(SitePageBlock $block, ErrorStore $errorStore) {
    ...
    $data['description'] = isset($data['description']) && is_string($data['description'])
      ? $data['description']
      : '';
    // No i18n maps (reverted to single fields for heading/description).
